...
"")
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 242, 1407))
        ...
        self.verticalLayout_21 = QVBoxLayout(self.widget_configuracion)
        self.verticalLayout_21.setObjectName(u"verticalLayout_21")
        self.verticalSpacer_3 = QSpacerItem(20, 40, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding)

        self.verticalLayout_21.addItem(self.verticalSpacer_3)

        self.boton_crear_usuarios = QPushButton(self.widget_configuracion)
        self.boton_crear_usuarios.setObjectName(u"boton_crear_usuarios")
        self.boton_crear_usuarios.setCursor(QCursor(Qt.PointingHandCursor))

        self.verticalLayout_21.addWidget(self.boton_crear_usuarios, 0, Qt.AlignmentFlag.AlignHCenter)

        self.boton_v_actulizar_usuarios = QPushButton(self.widget_configuracion)
        self.boton_v_actulizar_usuarios.setObjectName(u"boton_v_actulizar_usuarios")
        self.boton_v_actulizar_usuarios.setCursor(QCursor(Qt.PointingHandCursor))

        self.verticalLayout_21.addWidget(self.boton_v_actulizar_usuarios, 0, Qt.AlignmentFlag.AlignHCenter)
        ...
        self.verticalLayout_21.addWidget(self.boton_configurar_bd, 0, Qt.AlignmentFlag.AlignHCenter)
        ...
        self.gridLayout_9 = QGridLayout(self.widget_actualizar_usuarios)
        ...
        self.line_confirmar = QLineEdit(self.widget_actualizar_usuarios)
        self.line_confirmar.setObjectName(u"line_confirmar")
        self.line_confirmar.setEnabled(False)
        self.line_confirmar.setAlignment(Qt.AlignmentFlag.AlignCenter)

        self.gridLayout_8.addWidget(self.line_confirmar, 2, 0, 1, 2)

        self.boton_buscar_usuario = QPushButton(self.widget_actualizar_usuarios)
        ...
        self.gridLayout_8.addWidget(self.boton_buscar_usuario, 0, 1, 1, 1)

        self.line_usuario = QLineEdit(self.widget_actualizar_usuarios)
        self.line_usuario.setObjectName(u"line_usuario")
        self.line_usuario.setAlignment(Qt.AlignmentFlag.AlignCenter)

        self.gridLayout_8.addWidget(self.line_usuario, 0, 0, 1, 1)

        self.line_contrasena = QLineEdit(self.widget_actualizar_usuarios)
        ...
        self.gridLayout_8.addWidget(self.line_contrasena, 1, 0, 1, 2)

        self.boton_actualizar_usuario = QPushButton(self.widget_actualizar_usuarios)
        ...
        self.gridLayout_8.addWidget(self.boton_actualizar_usuario, 3, 0, 1, 2)

        self.boton_borrar_usuario = QPushButton(self.widget_actualizar_usuarios)
        self.boton_borrar_usuario.setObjectName(u"boton_borrar_usuario")
        self.boton_borrar_usuario.setEnabled(False)

        self.gridLayout_8.addWidget(self.boton_borrar_usuario, 4, 0, 1, 2)
        ...
        self.gridLayout_9.addItem(self.verticalSpacer_4, 0, 1, 1, 1)

        self.verticalSpacer_5 = QSpacerItem(20, 40, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding)

        self.gridLayout_9.addItem(self.verticalSpacer_5, 2, 1, 1, 1)
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QRect(0, 0, 232, 587))
        ...
        self.consulta_antecedentes.setMinimumSize(QSize(0, 0))
        ...
        QWidget.setTabOrder(self.boton_inicio, self.boton_v_consulta)
        QWidget.setTabOrder(self.boton_v_consulta, self.boton_v_citas)
        QWidget.setTabOrder(self.boton_v_citas, self.boton_v_agendar)
        QWidget.setTabOrder(self.boton_v_agendar, self.boton_v_pacientes)
        QWidget.setTabOrder(self.boton_v_pacientes, self.boton_v_registrar_pacientes)
        QWidget.setTabOrder(self.boton_v_registrar_pacientes, self.boton_v_consultas)
        QWidget.setTabOrder(self.boton_v_consultas, self.line_usuario)
        ...
        QWidget.setTabOrder(self.boton_actualizar_usuario, self.combo_nacionalidad_agenda)
        QWidget.setTabOrder(self.combo_nacionalidad_agenda, self.line_cedula_agenda)
        QWidget.setTabOrder(self.line_cedula_agenda, self.boton_buscar_agenda)
        QWidget.setTabOrder(self.boton_buscar_agenda, self.line_nombre_agenda)
        QWidget.setTabOrder(self.line_nombre_agenda, self.line_apellido_agenda)
        QWidget.setTabOrder(self.line_apellido_agenda, self.date_agenda)
        QWidget.setTabOrder(self.date_agenda, self.boton_agendar)
        QWidget.setTabOrder(self.boton_agendar, self.date_cita_desde)
        QWidget.setTabOrder(self.date_cita_desde, self.date_cita_hasta)
        QWidget.setTabOrder(self.date_cita_hasta, self.check_rango_cita)
        QWidget.setTabOrder(self.check_rango_cita, self.boton_buscar_cita)
        QWidget.setTabOrder(self.boton_buscar_cita, self.tabla_citas)
        QWidget.setTabOrder(self.tabla_citas, self.boton_crear_usuarios)
        QWidget.setTabOrder(self.boton_crear_usuarios, self.boton_v_actulizar_usuarios)
        QWidget.setTabOrder(self.boton_v_actulizar_usuarios, self.boton_configurar_bd)
        QWidget.setTabOrder(self.boton_configurar_bd, self.scrollArea_2)
        QWidget.setTabOrder(self.scrollArea_2, self.combo_consulta_antecedentes)
        QWidget.setTabOrder(self.combo_consulta_antecedentes, self.line_consulta_cedula)
        QWidget.setTabOrder(self.line_consulta_cedula, self.boton_consulta_cedula)
        QWidget.setTabOrder(self.boton_consulta_cedula, self.line_consulta_nombre)
        QWidget.setTabOrder(self.line_consulta_nombre, self.line_consulta_apellido)
        QWidget.setTabOrder(self.line_consulta_apellido, self.boton_ver_antecedentes)
        QWidget.setTabOrder(self.boton_ver_antecedentes, self.date_primera_relacion_consulta)
        QWidget.setTabOrder(self.date_primera_relacion_consulta, self.text_antecedente_patologico)
        QWidget.setTabOrder(self.text_antecedente_patologico, self.text_antecedentes_quirurjicos)
        QWidget.setTabOrder(self.text_antecedentes_quirurjicos, self.text_consulta_diagnostico)
        QWidget.setTabOrder(self.text_consulta_diagnostico, self.text_consulta_tratamiento)
        QWidget.setTabOrder(self.text_consulta_tratamiento, self.check_proxima_cita_consulta)
        QWidget.setTabOrder(self.check_proxima_cita_consulta, self.date_proxima_cita_consulta)
        QWidget.setTabOrder(self.date_proxima_cita_consulta, self.check_embarazo_consulta)
        QWidget.setTabOrder(self.check_embarazo_consulta, self.date_consulta_ultima_regla)
        QWidget.setTabOrder(self.date_consulta_ultima_regla, self.date_consulta_parto)
        QWidget.setTabOrder(self.date_consulta_parto, self.boton_fin_consulta)
        QWidget.setTabOrder(self.boton_fin_consulta, self.combo_nacionalidad_consultas)
        QWidget.setTabOrder(self.combo_nacionalidad_consultas, self.line_cedula_consultas)
        QWidget.setTabOrder(self.line_cedula_consultas, self.boton_buscar_consultas)
        QWidget.setTabOrder(self.boton_buscar_consultas, self.table_consultas)
        QWidget.setTabOrder(self.table_consultas, self.check_editar_consultas)
        QWidget.setTabOrder(self.check_editar_consultas, self.text_diagnostico_edit)
        QWidget.setTabOrder(self.text_diagnostico_edit, self.text_tratamiento_edit)
        QWidget.setTabOrder(self.text_tratamiento_edit, self.boton_actualizar_consultas)
        QWidget.setTabOrder(self.boton_actualizar_consultas, self.boton_borrar_consultas)
        QWidget.setTabOrder(self.boton_borrar_consultas, self.scrollArea)
        QWidget.setTabOrder(self.scrollArea, self.combo_nacionalidad)
        QWidget.setTabOrder(self.combo_nacionalidad, self.line_cedula_buscar)
        QWidget.setTabOrder(self.line_cedula_buscar, self.boton_buscar)
        QWidget.setTabOrder(self.boton_buscar, self.check_datos_personales)
        QWidget.setTabOrder(self.check_datos_personales, self.line_nombre_editar)
        QWidget.setTabOrder(self.line_nombre_editar, self.line_apellido_editar)
        QWidget.setTabOrder(self.line_apellido_editar, self.date_fecha_nacimiento)
        QWidget.setTabOrder(self.date_fecha_nacimiento, self.line_telefono_editar)
        QWidget.setTabOrder(self.line_telefono_editar, self.text_direccion_editar)
        QWidget.setTabOrder(self.text_direccion_editar, self.check_proxima_cita)
        QWidget.setTabOrder(self.check_proxima_cita, self.date_proxima_cita)
        QWidget.setTabOrder(self.date_proxima_cita, self.check_consulta)
        QWidget.setTabOrder(self.check_consulta, self.text_diagnostico)
        QWidget.setTabOrder(self.text_diagnostico, self.text_tratamiento_consulta)
        QWidget.setTabOrder(self.text_tratamiento_consulta, self.check_antecedentes)
        QWidget.setTabOrder(self.check_antecedentes, self.text_patologicos)
        QWidget.setTabOrder(self.text_patologicos, self.text_quirurjicos)
        QWidget.setTabOrder(self.text_quirurjicos, self.text_tratamiento)
        QWidget.setTabOrder(self.text_tratamiento, self.date_relaciones)
        QWidget.setTabOrder(self.date_relaciones, self.check_embarazo)
        QWidget.setTabOrder(self.check_embarazo, self.date_ultima_regla)
        QWidget.setTabOrder(self.date_ultima_regla, self.date_parto)
        QWidget.setTabOrder(self.date_parto, self.boton_borrar_paciente)
        QWidget.setTabOrder(self.boton_borrar_paciente, self.boton_actualizar_datos)
        QWidget.setTabOrder(self.boton_actualizar_datos, self.boton_imprimir)
        QWidget.setTabOrder(self.boton_imprimir, self.date_primera_relacion)
        QWidget.setTabOrder(self.date_primera_relacion, self.text_antecedente_patologico_registro)
        QWidget.setTabOrder(self.text_antecedente_patologico_registro, self.text_antecedente_quirurjico_registro)
        QWidget.setTabOrder(self.text_antecedente_quirurjico_registro, self.text_tratamiento_registro)
        QWidget.setTabOrder(self.text_tratamiento_registro, self.boton_registrar_antecedentes)
        QWidget.setTabOrder(self.boton_registrar_antecedentes, self.nacionalidad)
        ...
        QWidget.setTabOrder(self.boton_v_cerrar_sesion, self.text_tratamiento_actual)
...
"CONSULTAS", None))
        ...
        self.boton_crear_usuarios.setText(QCoreApplication.translate("SANDIASALUD", u"CREAR USUARIOS", None))
        self.boton_v_actulizar_usuarios.setText(QCoreApplication.translate("SANDIASALUD", u"ACTUALIZAR USUARIOS", None))
        self.boton_configurar_bd.setText(QCoreApplication.translate("SANDIASALUD", u"CONFIGURAR BD", None))
        self.line_confirmar.setPlaceholderText(QCoreApplication.translate("SANDIASALUD", u"CONFIRMAR CONTRASE\u00d1A", None))
        self.boton_buscar_usuario.setText(QCoreApplication.translate("SANDIASALUD", u"BUSCAR", None))
        self.line_usuario.setPlaceholderText(QCoreApplication.translate("SANDIASALUD", u"USUARIO", None))
        self.line_contrasena.setPlaceholderText(QCoreApplication.translate("SANDIASALUD", u"NUEVA CONTRASE\u00d1A", None))
        self.boton_actualizar_usuario.setText(QCoreApplication.translate("SANDIASALUD", u"ACTUALIZAR", None))
        self.boton_borrar_usuario.setText(QCoreApplication.translate("SANDIASALUD", u"BORRAR", None))
